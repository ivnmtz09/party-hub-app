            ...
            {grupos.map((g) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left py-3 px-4 font-black uppercase tracking-wider text-sm border-b-2 border-black dark:border-white last:border-b-0 transition-colors ${
                    isActive
