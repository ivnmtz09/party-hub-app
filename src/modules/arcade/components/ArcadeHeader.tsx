...
export default function ArcadeHeader() {
  return (
    <div className="sticky top-0 z-20 bg-yellow-300 dark:bg-fuchsia-600 border-b-4 border-black dark:border-white flex items-center justify-between h-12 px-4">
      <BrandLogo size="sm" />
